...
MULの外形480×346.6 µm。MACはMULをFAの上段へ配置し、外接矩形 **1774.7×969.65 µm**。
全形状の範囲は x=6.3〜1781 µm、y=12.35〜982 µmで、指定の **1800×1000 µm** 領域内に収まる。
...
最終の共有VSS配線40 µm化後にDrawing DRC/LVSと抽出81入力を再実行した。
