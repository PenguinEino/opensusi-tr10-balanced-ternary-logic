...
def main():
 ...
 labels={'VDD':(1770,ports['VDD']['position_um'][1]-65),'VSS':(1770,ports['VSS']['position_um'][1]+65),'VMID':(110,890),'a':(-70,520),'b':(-70,650),'x':(110,450),'cin':(790,450),'and_out':(690,640),'or_out':(1220,640),'sum':(1520,310),'cout':(1690,0)}
 for name,p in ports.items():
